...
INSERT INTO `movies` VALUES (1,'Phantastische Tierwesen und wo sie zu finden sind','Phantastische Tierwesen und wo sie zu finden sind: Spinoff von \"Harry Potter\", mit dem die Autorin der Buchvorlagen ihr Debüt als Drehbuchautorin gibt.','http://localhost/PopCornMovies/assets/gfx/phantastische-tierwesen.jpg'),(2,'Arrival','Arrival: Science-Fiction-Film über die Begegnung zwischen Menschen und Aliens.','http://localhost/PopCornMovies/assets/gfx/arrival.jpg'),(3,'Bad Santa 2','Bad Santa 2: Fortsetzung der schwarzen Komödie mit Billy Bob Thornton.','http://localhost/PopCornMovies/assets/gfx/bad-santa-2.jpg'),(4,'Doctor Strange','Doctor Strange: Marvel-Leinwand-Abenteuer um einen ehemaligen Chirurgen mit magischen Fähigkeiten.','http://localhost/PopCornMovies/assets/gfx/doctor-strange.jpg'),(5,'Girl on the Train','Girl on the Train: Thriller nach dem gleichnamigen US-Bestseller um eine Frau, die in einen Mord verwickelt wird.','http://localhost/PopCornMovies/assets/gfx/girl-on-the-train.jpg'),(6,'Findet Dorie','Findet Dorie: Sequel zum Pixar-Blockbuster \"Findet Nemo\", in dem Dorie gesucht wird.','http://localhost/PopCornMovies/assets/gfx/findet-dorie.jpg'),(10,'Amerikanisches Idyll','Amerikanisches Idyll: Ewan McGregors Regiedebüt nach dem gleichnamigen Roman von Philip Roth.','http://localhost/PopCornMovies/assets/gfx/amerikanisches-idyll.jpg'),(11,'Café Society','Café Society: Bittersüße Liebes- und Aufsteigergeschichte im Hollywood der 1930er Jahre.','http://localhost/PopCornMovies/assets/gfx/cafe-society.jpg'),(12,'Eine Geschichte von Liebe und Finsternis','Eine Geschichte von Liebe und Finsternis: Natalie Portmans Regiedebüt, über die Kindheit des israelischen Schriftstellers Amos Oz.','http://localhost/PopCornMovies/assets/gfx/geschichte-von-liebe.jpg'),(13,'Jeder stirbt für sich allein - Alone in Berlin','Jeder stirbt für sich allein: Neuverfilmung des Romans von Hans Fallada um ein Arbeiterehepaar, das Widerstand gegen die Nazis leistet.','http://localhost/PopCornMovies/assets/gfx/jeder-stirbt.jpg'),(14,'Bridget Jones\' Baby','Bridget Jones\' Baby: Weiterer Teil der erfolgreichen \"Bridget Jones\"-Reihe mit Renée Zellweger, die dieses Mal ein Kind erwartet.','http://localhost/PopCornMovies/assets/gfx/bridget-jones.jpg'),(15,'Deepwater Horizon','Deepwater Horizon: Katastrophenthriller, der sich der Ereignisse aus dem Jahr 2010 auf der gleichnamigen Bohrinsel annimmt.','http://localhost/PopCornMovies/assets/gfx/deepwater.jpg'),(16,'Jack Reacher: Kein Weg zurück','Jack Reacher: Kein Weg zurück: Die Fortsetzung des Actionthrillers mit Tom Cruise als Lee Childs Kultermittler Jack Reacher.','http://localhost/PopCornMovies/assets/gfx/jack-reacher.jpg');
...
-- Dump completed on 2016-12-01 14:13:40
