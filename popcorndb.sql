...
INSERT INTO `movies` VALUES (1,'Phantastische Tierwesen und wo sie zu finden sind','Phantastische Tierwesen und wo sie zu finden sind: Spinoff von \"Harry Potter\", mit dem die Autorin der Buchvorlagen ihr Debüt als Drehbuchautorin gibt.'),(2,'Arrival','Arrival: Science-Fiction-Film über die Begegnung zwischen Menschen und Aliens.'),(3,'Bad Santa 2','Bad Santa 2: Fortsetzung der schwarzen Komödie mit Billy Bob Thornton.'),(4,'Doctor Strange','Doctor Strange: Marvel-Leinwand-Abenteuer um einen ehemaligen Chirurgen mit magischen Fähigkeiten.'),(5,'Girl on the Train','Girl on the Train: Thriller nach dem gleichnamigen US-Bestseller um eine Frau, die in einen Mord verwickelt wird.'),(6,'Findet Dorie','Findet Dorie: Sequel zum Pixar-Blockbuster \"Findet Nemo\", in dem Dorie gesucht wird.'),(10,'Amerikanisches Idyll','Amerikanisches Idyll: Ewan McGregors Regiedebüt nach dem gleichnamigen Roman von Philip Roth.'),(11,'Café Society','Café Society: Bittersüße Liebes- und Aufsteigergeschichte im Hollywood der 1930er Jahre.'),(12,'Eine Geschichte von Liebe und Finsternis','Eine Geschichte von Liebe und Finsternis: Natalie Portmans Regiedebüt, über die Kindheit des israelischen Schriftstellers Amos Oz.'),(13,'Jeder stirbt für sich allein - Alone in Berlin','Jeder stirbt für sich allein: Neuverfilmung des Romans von Hans Fallada um ein Arbeiterehepaar, das Widerstand gegen die Nazis leistet.'),(14,'Bridget Jones\' Baby','Bridget Jones\' Baby: Weiterer Teil der erfolgreichen \"Bridget Jones\"-Reihe mit Renée Zellweger, die dieses Mal ein Kind erwartet.'),(15,'Deepwater Horizon','Deepwater Horizon: Katastrophenthriller, der sich der Ereignisse aus dem Jahr 2010 auf der gleichnamigen Bohrinsel annimmt.'),(16,'Jack Reacher: Kein Weg zurück','Jack Reacher: Kein Weg zurück: Die Fortsetzung des Actionthrillers mit Tom Cruise als Lee Childs Kultermittler Jack Reacher.'),(18,'Doctor Strange','Doctor Strange: Marvel-Leinwand-Abenteuer um einen ehemaligen Chirurgen mit magischen Fähigkeiten.');
...
-- Dump completed on 2016-11-29  9:45:01
